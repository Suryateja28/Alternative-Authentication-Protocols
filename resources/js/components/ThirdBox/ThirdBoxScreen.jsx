...
const ThirdBoxScreen = ({ onBack }) => {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-900 p-4">
                <div className="max-w-md w-full bg-slate-800/80 backdrop-blur-xl rounded-3xl p-8 border border-slate-700 shadow-2xl text-center">
                    ...
                    <p className="text-slate-400 mb-8">You have successfully authenticated using Device State Authentication.</p>
                    <button 
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-900 p-4 relative overflow-hidden">
            ...
            <div className="absolute top-[-10%] right-[10%] w-[40%] h-[40%] rounded-full bg-amber-600/20 blur-[120px] pointer-events-none" />
            <div className="absolute bottom-[-10%] left-[10%] w-[40%] h-[40%] rounded-full bg-orange-600/20 blur-[120px] pointer-events-none" />
            ...
            <div className="relative z-10 w-full max-w-md bg-slate-800/80 backdrop-blur-xl rounded-3xl p-8 border border-slate-700 shadow-2xl">
                {isLoginMode ? (
                    <LoginDevice onToggleMode={toggleMode} onLoginSuccess={handleLoginSuccess} />
                ) : (
                    <RegisterDevice onToggleMode={toggleMode} />
                )}
            </div>
        </div>
    );
